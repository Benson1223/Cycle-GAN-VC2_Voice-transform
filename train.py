...
# os.environ["CUDA_VISIBLE_DEVICES"] = "3" 這段可指定使用哪顆gpu
...
class CycleGANTraining(object):
    def __init__(self,
        ...
        self.start_epoch = 0
        self.num_epochs = 6100  # 5000
        self.mini_batch_size = 16  # 1
        ...
        self.generator_lr = 2e-4  # 0.0002 ori 2e-4
        ...
        self.start_decay = 30000  # 200000 ori 10000
